...
class SAM2CameraPredictor(SAM2Base):
    ...
    def _consolidate_temp_output_across_obj(
        ...
        for obj_idx in range(batch_size):
            ...
            if out is None:
                print("This frame has no temp output for obj: ", obj_idx)
            ...
            if out is None:
                print("This should appear if there is no temp output for: ", obj_idx)
    ...
    def add_new_prompt_during_track(
        ...
        if first_hit:
            ...
            self.object_tracked=[False, False, False, False]
        ...
        self.object_tracked[obj_id]= True
